...
<SourceCode fileName="single.tsx" />

<RenderingBox>{/* <Single /> */}</RenderingBox>
...
<SourceCode fileName="single-required.tsx" />
...
<SourceCode fileName="custom-multiple.tsx" />

<RenderingBox>{/* <CustomMultiple /> */}</RenderingBox>
